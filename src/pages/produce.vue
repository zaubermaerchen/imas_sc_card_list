<template>
    <section>
        <ul class="navigation">
            <li class="selected"><router-link to="/produce">プロデュースアイドル</router-link></li>
            <li><router-link to="/support">サポートアイドル</router-link></li>
        </ul>
...
<script lang="ts">
    import Vue from "vue";
    import ProduceCard from "../components/produce_card";
    ...
    export default Vue.extend({
        ...
        methods: {
            search: function (offset: number = 0): void {
                api.searchProduceCard(this.idol_id_list, this.rarities, this.limit, offset).then((json: any) => {
